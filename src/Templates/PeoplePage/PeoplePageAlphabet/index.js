...
const PeoplePageAlphabet = ({alphabet, theme, isMobile}) => {
...
PeoplePageAlphabet.propTypes = {
    alphabet: PropTypes.array.isRequired,
    theme: PropTypes.object,
    isMobile: PropTypes.bool
}

PeoplePageAlphabet.defaultProps = {
    theme: {}
}
...
export default connect(mapStateToProps)(PeoplePageAlphabet)