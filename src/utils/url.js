 ...
 * @returns {string}
 */
export const composeGoogleMapsUrl = (company = null, address1 = null, address2 = null, city = null, state = null, postalCode = null) =>
    'https://maps.google.com/?q=' + [company, address1, address2, city, state, postalCode].join('+').replace(/\s/g, "+")
